...
## Triángulo de Pascal
\begin{center}
```{r, echo=FALSE, label=pas1,fig.cap="",out.width = "400px"}
knitr::include_graphics("Images/tpascal1",dpi=1200)
```
\end{center}
...
## Triángulo de Pascal
\begin{center}
```{r, echo=FALSE, label=pas2,fig.cap="",out.width = "400px"}
knitr::include_graphics("Images/tpascal2",dpi=1200)
```
\end{center}
...
<!-- \begin{frame}{La fórmula del binomio de Newton} -->
