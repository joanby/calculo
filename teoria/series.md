...
Es el caso de la serie $\displaystyle{\sum \dfrac{(-1)^n}{n}}$ es convergente, en tanto que la serie de valores absolutos  es la serie armónica que ya hemos visto que era divergente.  
