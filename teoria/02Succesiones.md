...
$$
a_1 \leq a_2 \leq \ldots \leq a_{n-1} \leq a_n
$$
...
Por una parte, tenemos que para $k = 1, 2 ,\ldots n$, es $(1-\frac{k}{n} )<1$. Por la otra, se puede demostrar por inducción que $2^{k-1} \leq k!$, por lo tanto es $\frac{1}{k!} \leq \frac{1}{2^{k-1}}$. E definitiva, , para $n >1$ se verifica que
$$
...
$$
 puesto que se trata de la suma de los términos de una progresión geométrica de razón $\frac{1}{2}$. 
...
$$
De esta ecuación sabemos que tiene, por lo menas u solución real, por lo que su discriminante deberá ser positivo, es decir
$$
4a_n^2 -4a \geq 0
$$
