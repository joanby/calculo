...
<l class="definition">Definición</l> 
  ...
  * Un subconjunto $A \subset \mathbb{R}$ está **acotado superiormente** si existe un $\alpha \in \mathbb{R}$ tal que $a \leq \alpha$ para todo $a \in A$. Al elemeto $\alpha$ se le llama **cota superior** del conjunto $A$.
