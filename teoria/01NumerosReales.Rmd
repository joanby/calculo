...
\ldots
$$
Consideremos ahora el número $a=0.b_1b_2b_3 \ldots b_n \ldots$, en el que cada $b_k=a_{kk}+1$, si $a_{kk} \neq 8$, y $b_k = 0$, si $a_{kk} = 8$. El número $a$ no está en la lista de números anterior, puesto que si ocupase el lugar $k$ diferiria del correspondiente $a_k$ precisamente en la cifra que ocupa el lugar $k$. 
