...
Dado que en $I_1 =[a_1,b_1]$ hay infinitos puntos de $A$, podemos repetir el proceso y determinar así un intervalo $I_2 = [a_2,b_2]$, con infinitos puntos de $A$ y tal que $I_2 \subset I_1$ y que $b_2-a_2= \dfrac{b_1 - a_1}{2}= \dfrac{K}{2^2}$. 
...
Además,  el $\inf \{\dfrac{k}{2^n}: n \in \mathbb{N} \}$, existe puesto que se trata de un conjunto acotado inferiormente por $0$. Este ínfimo no puede ser positivo, puesto que si existe $0 < r <\dfrac{1}{2^n}$ para todo $n \in \mathbb{N}$, resultaria que tendria que ser $2^n < \dfrac{1}{r}$, o lo que es lo mismo, $n \log 2 <-\log r$ y, por lo tanto, $n < -\dfrac{\log r}{\log 2}$, lo que signiciaría que los números naturales estan acotados en $\mathbb{R}$ y ya hemos visto que no puede ser.
