...
Está claro que dos conjuntos finitos con el mismo número de elementos tienen el mismo cardianl, pero ¿qué pasa con los conjutos infinitos? 

Hemos visto un ejemplo de una aplicación biyectiva entre los conjuntos $\mathbb{Z}$ y $\mathbb{N}$ y, por lo tanto tienen el mismo cardinal, aunque $\mathbb{N} \subset \mathbb{Z}$. Conviene observar que esta es una característica de los conjuntos infinitos: pueden tenr el mismo cardinal que alguno de sus subconjuntos propios.
...
<l class="example"> **Ejemplo** </l>

El conjunto $Z$ de los números enteros es numerable. También lo es el conjunto de los números naturales pares o el de los múltiplos de otro número natural $k$.


## El conjunto de los números racionales es numerable

\begin{tabular}{cccccccccccc}
$\dfrac{1}{1}$ & & $\dfrac{1}{2}$ &$\rightarrow$& $\dfrac{1}{3}$ && $\dfrac{1}{4}$ & $\rightarrow$ &  $\ldots$&  & $\dfrac{1}{n}$ & \\
 $\downarrow $ &$\nearrow$ && $\swarrow$  && $\nearrow$ &&  & &  &  \\
  $\dfrac{2}{1}$ && $\dfrac{2}{2}$ && $\dfrac{2}{3}$ && $\dfrac{2}{4}$ && $\ldots$ && $\dfrac{2}{n}$
 & \\
 &$\swarrow$ && $\nearrow$  && $\swarrow$ &&  & &  &  \\
 $\dfrac{3}{1}$ && $\dfrac{3}{2}$ && $\dfrac{3}{3}$ && $\dfrac{3}{4}$ && $\ldots$ && $\dfrac{3}{n}$
 & \\
 $\downarrow $ &$\nearrow$ && $\swarrow$  && $\nearrow$ &&  & & &  \\
 $\dfrac{4}{1}$ && $\dfrac{4}{2}$ && $\dfrac{4}{3}$ && $\dfrac{4}{4}$ && $\ldots$ && $\dfrac{4}{n}$
 & \\
...
Observación: como se verá más adelante, un conjunto indexado por los números naturales, como lo son $\{I_n\}$, $\{a_n\}$ y $\{b_n\}$, reciben el nombre de **sucesiones**
...
Es decir, el conjunto de exteremos inferiores de los intervalos $\{a_n: n \in \mathbb{N}\}$ está acotado superiormente por cualquiera de los $b_n$. Sea $\xi$ el supremo de este conjunto. Está claro que $a_n \leq \xi}, para todo $n \in \mathbb{N}$, puesto que  $\xi$ es el supremo de todos los $a_n$.
