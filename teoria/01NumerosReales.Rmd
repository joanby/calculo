...
<l class="proposicion">**Proposición**</l>
...
Supongamos que si, que existen cotas superiores para $\mathbb{N}$ en $\mathbb{R}$, por el axioma del supremo deberá existir $\alpha = \sup \mathbb{N}$. Al ser $\alpha$ la menor de las cotas superiores, resultará que $\alpha -1$ no es cota superior. Por lo tanto exite un $n \in \mathbb{N}$ tal que $\alpha -1 <n$, es decir que $\alpha < n+1$, lo cual es absurdo, puesto que habíamos supuesto que $\alpha$ era mayor que todos los nombres naturales.
