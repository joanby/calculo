...
## Los números reales: $\mathbb{R}$
  ...
  * Propiedades del producto de números reales:
      ...
      + Para cada $a \in \mathbb{R}$ existe un elemento $\dfrac{1}{a} = a^{-1} \in \mathbb{R}$, inverso de $a$, tal que $a \cdot a^{-1}=1=a ^{-1}\cdot a$
...
##  Los números reales incluyen los naturales, enteros y racionales: $\mathbb{N} \subset \mathbb{Z} \subset \mathbb{Q} \subset \mathbb{R}$
  ...
  * Dado que en $\mathbb{R}$ existe un elemento neutro para el producto, $1$, podemos asimilar el número natural $n$ con el número real $1+ \ldots n) \ldots + 1$
  
  * Dado que en $\mathbb{R}$, existe $-1$, el simétrico de $1$, podemos asimilar el número entero $-n$ con el número real $(-1)+(-1) \ldots +(-1)$
      
## El orden de los números reales: $\mathbb{R}$

Para definir una relción de orden entre los números reales, supondremos que existe un subconjunto $P$ de números reales tal que:
    
  1. Cualquier número real o està en $P$ o és igual a $0$ o su simétrico está en P:
