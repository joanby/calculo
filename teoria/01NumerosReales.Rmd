...
PA. Propiedada asociativa: $a\times (b \times c) = a \times b)\times c$, para todo $a,b,c \in \mathbb{Z}$
...
ES. Elemento simétrico, $\dfrac{1}{p}$. $p \cdot \dfrac{1}{p} = \dfrac{1}{p} \cdot p =1$, para todo $p \in Q$, $p \neq 0$

PC. Propiedad conmutativa $p \cdot q = q \cdot p$, para todo $p,q \in \mathbb{Q}$.

PA. Propiedada asociativa: $p\cdot (q \cdot r) = p \cdot q)\cdot r$, para todo $p,q,r \in \mathbb{Q}$
