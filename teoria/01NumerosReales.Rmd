...
Sean $n \in \mathbb{N}$ y $N_n$ el conjunto de los $n$ primeros números naturales. La aplicación $f(k)=k$ es inyectiva, pero no exhaustiva, ya que todos los naturales  mayores que $n$ no son  imagen de ningún elemento de $N_n$.
</div>
