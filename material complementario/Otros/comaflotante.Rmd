...
```{r, echo=FALSE, label=taules,fig.cap="",out.width = "400px"}
knitr::include_graphics("taules.jpg",dpi=600)
```
</div>
...
<div class="center">
```{r, echo=FALSE, label=b4358,fig.cap="",out.width = "800px"}
knitr::include_graphics("0b43.png",dpi=600)
knitr::include_graphics("0b58.png",dpi=600)
```
</div>
...
<div class="center">
```{r, echo=FALSE, label=comp2,fig.cap="",out.width = "600px"}
knitr::include_graphics("comp2.png",dpi=600)
```
</div>
...
<div class="center">
```{r, echo=FALSE, label=comp21,fig.cap="",out.width = "600px"}
knitr::include_graphics("suma.png",dpi=600)
```
</div>
...
<div class="center">
```{r, echo=FALSE, label=comp22,fig.cap="",out.width = "600px"}
knitr::include_graphics("suma1.png",dpi=600)
```
</div>
...
<div class="center">
```{r, echo=FALSE, label=fracbin1,fig.cap="",out.width = "250px"}
knitr::include_graphics("fracbin1.jpg",dpi=600)
```
</div>
...
<div class="center">
```{r, echo=FALSE, label=fracbin2,fig.cap="",out.width = "600px"}
knitr::include_graphics("fracbin2.png",dpi=600)
```
</div>
...
<div class="center">
```{r, echo=FALSE, label=fracbin3,fig.cap="",out.width = "400px"}
knitr::include_graphics("fracbin3.jpg",dpi=600)
```
</div>
...
<div class="center">
```{r, echo=FALSE, label=fracbin4,fig.cap="",out.width = "600px"}
knitr::include_graphics("fracbin4.png",dpi=600)
```
</div>
...
<div class="center">
```{r, echo=FALSE, label=float,fig.cap="",out.width = "800px"}
knitr::include_graphics("float1.jpg",dpi=600)
```
</div>
...
<div class="center">
```{r, echo=FALSE, label=float2,fig.cap="",out.width = "800px"}
knitr::include_graphics("float2.jpg",dpi=600)
```
</div>
...
<div class="center">
```{r, echo=FALSE, label=simple,fig.cap="",out.width = "1000px"}
knitr::include_graphics("simple.jpg",dpi=600)
```
</div>

Distribución de los bits en precisión doble:
```{r, echo=FALSE, label=doble,fig.cap="",out.width = "1000px"}
knitr::include_graphics("doble.jpg",dpi=600)
```
</div>
...
<div class="center">
```{r, echo=FALSE, label=ieee75401,fig.cap="",out.width = "1000px"}
knitr::include_graphics("ieee7540.jpg",dpi=600)
knitr::include_graphics("ieee754_1.png",dpi=600)
```
</div>
...
## Representación de números reales
<div class="center">
```{r, echo=FALSE, label=ieee75423,fig.cap="",out.width = "1000px"}
knitr::include_graphics("ieee754_2.png",dpi=1200)
knitr::include_graphics("ieee754_3.png",dpi=1200)
```
</div>
...
<div class="center">
```{r, echo=FALSE, label=ieee75424,fig.cap="",out.width = "650px"}
knitr::include_graphics("conversor.png",dpi=1200)
```
...
<div class="center">
```{r, echo=FALSE, label=ieee75425,fig.cap="",out.width = "750px"}
knitr::include_graphics("conversor1.png",dpi=1200)
```
</div>
