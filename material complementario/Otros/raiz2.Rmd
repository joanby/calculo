...
<div class="center">
```{r, echo=FALSE, label=raizc2,fig.cap="",out.width = "300px"}
knitr::include_graphics("raizc2.png",dpi=600)
```
</div>
...
<div class="center">
```{r, echo=FALSE, label=ybc,fig.cap="",out.width = "600px"}
knitr::include_graphics("ybc.jpg",dpi=600)
...
<div class="center">
```{r, echo=FALSE, label=graf,fig.cap="",out.width = "750px"}
knitr::include_graphics("dibuix.png",dpi=600)
```
</div>
...
<div class="center">
```{r, echo=FALSE, label=mesop1,fig.cap="",out.width = "750px"}
knitr::include_graphics("mesop1.png",dpi=600)
...
<div class="center">
```{r, echo=FALSE, label=exem1,fig.cap="",out.width = "600px"}
knitr::include_graphics("exem1.png",dpi=600)
knitr::include_graphics("exem2.png",dpi=600)
knitr::include_graphics("exem3.png",dpi=600)
```
</div>
...
<div class="center">
```{r, echo=FALSE, label=exem5,fig.cap="",out.width = "800px"}
knitr::include_graphics("exem5.png",dpi=600)
```
</div>
...
<div class="center">
```{r, echo=FALSE, label=exem6,fig.cap="",out.width = "600px"}
knitr::include_graphics("exem6.png",dpi=600)
knitr::include_graphics("exem7.png",dpi=600)
```
</div>
