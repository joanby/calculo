...
$$
Para estudiar su convergencia, aplicaremos el \red{criterio de comparación por cociente} con la función $x^{p-1}$:
$$
...
Para estudiar la \blue{convergencia} de la integral impropia $I_2=\displaystyle I_2=\int_1^\infty x^{t-1}\mathrm{e}^{-x}\, dx$, aplicamos el \red{criterio de comparación por cociente} con la integral impropia $\displaystyle \int_1^\infty \mathrm{e}^{-x}\, dx$:
$$
