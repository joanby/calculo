...
1. Dar los extremos relativos y los intervalos de crecimiento y decrecimiento de las funciones siguientes:
    ...
    a) $k(x)=x^4+2x^2-4$.\newline\newline
**Solución**\newline
Para hallar los extremos de $f(x)=x^2-3x+5$, primero tenemos que derivar e igualar la derivada a cero:
$$
...
Hagamos lo mismo para la función $h(x)=x^3-3x-4$:
$$
...
**Solución**\newline
Para hallar los extremos relativos de la función $f(x)=x+\frac{1}{x}$ para $x\neq 0$ hay que derivar e igualar a cero la función derivada:
$$
...
Estudio para la función $h(x)=\sqrt{x}-2\sqrt{x+1}$ para $x>0$. La derivada y los ceros de la misma son:
$$
...
Estudio para la función $g(x)=\frac{x}{x^2+1}$. La derivada y los ceros de la misma son:
$$
