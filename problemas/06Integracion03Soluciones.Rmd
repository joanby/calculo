...
$$
\int_1^\infty \frac{1}{x^\frac{3}{2}}\, dx =\lim_{c\to\infty}\int_1^c x^{-\frac{3}{2}}\, dx=\lim_{c\to\infty} \left[\frac{x^{-\frac{1}{2}}}{-\frac{1}{2}}\right]_1^c =-2\cdot\lim_{c\to\infty} c^{-\frac{1}{2}}-1=2,
$$
